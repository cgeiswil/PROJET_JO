...
<body>
    ...
    <h1>Graphiques des records de Natation</h1>
  ...
  <ul>
    <li class="deroulant">
      ...
      require("fonction.php");
       $bdd = getBDD();
       $nom_discipline = "Swimming";
       $sexe = $_GET['sexe'];
       if ($sexe == "H") {
       	echo "<a href='Graphique_record_Swimming.php?sexe=H'>Liste des &eacute;preuves</a>";
        	...
        	epreuves.id_disciplines=disciplines.id_discipline AND disciplines.nom_discipline='$nom_discipline' AND epreuves.epreuves LIKE '_________men%' GROUP BY epreuves.id_epreuves";
        	$resultat = $bdd->query($requete);
        } else if ($sexe == "F") {
          echo "<a href='Graphique_record_Swimming.php?sexe=F'>Liste des &eacute;preuves</a>";
        	$requete = "SELECT nom_discipline, epreuves.id_epreuves, epreuves.epreuves FROM disciplines, lier_r, records, epreuves 
        	WHERE records.id_record=lier_r.id_record AND lier_r.id_epreuve=epreuves.id_epreuves AND 
      ...
      <ul class="sous">
        <?php
          while ($ligne = $resultat->fetch()) {
            ...
            echo "<li><a href='Graphique_record_Swimming.php?nom_discipline=$nom_discipline&id_epreuve=$id_epreuve&sexe=$sexe'>$epreuve</a></li>";
          }
        ?>
      </ul>
    </li>
